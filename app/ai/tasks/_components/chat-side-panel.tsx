          ...
          >
            ...
            >
              ...
              <div className="space-y-1.5">
                <h3 className="font-semibold text-2xl text-app-text-primary tracking-tight">Drop to Focus</h3>
                <p className="text-app-text-muted text-sm max-w-[200px] leading-relaxed">
      ...
      <div className="flex-1 overflow-hidden relative pb-6">
        {messages.length === 0 ? (
          <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center">
            ...
            <h3 className="text-app-text-primary font-medium mb-2">How can I help you?</h3>
