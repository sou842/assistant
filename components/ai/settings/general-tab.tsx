  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="space-y-1">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between py-4 border-b border-app-border-default/50 gap-4">
          <div>
            <h3 className="text-sm font-medium text-app-text-primary">Logout</h3>
            <p className="text-[13px] text-app-text-muted mt-0.5">Sign out of your account on this device.</p>
          </div>
          <button
            onClick={() => signOut()}
            className="flex items-center justify-center gap-2 px-4 py-2 rounded-full text-sm transition-colors cursor-pointer text-app-danger-strong bg-app-danger-soft hover:bg-app-danger hover:text-white font-medium"
          >
