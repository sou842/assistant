...
import { CheckIcon, Globe, PlusIcon, User, Search, MessageSquare, X, BookOpenCheck, Image as ImageIcon, FileText, Table2, Mail, Loader2, Trash2, Plus } from "lucide-react";
    ...
    <div className={className || `absolute bottom-0 left-0 right-0 z-20 p-${space}`}>
      <div className="mx-auto w-full max-w-3xl relative">
        ...
        {showContactSelector && (
          ...
          >
            <div className="p-3 border-b border-app-border-subtle bg-white/2 flex items-center justify-between">
            ...
            {isAddingContact ? (
              <form onSubmit={handleAddContact} className="p-3 flex flex-col gap-2">
                <input
                  type="text"
                  placeholder="Name"
